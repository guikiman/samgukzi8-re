...
export interface SandboxSnapshot {
    ...
    readonly capturedState: string; // JSON 직렬화된 상태
}
...
export class EventSandbox {
    ...
    private captureState: StateCaptureFn;
    private restoreState: StateRestoreFn;
    ...
    async executeSafe(event: GameEvent): Promise<SandboxResult> {
