...
export class WorkerMemoryOptimizer {
  private objectPoolSize = 0;
  private transferableCount = 0;
  private sharedBufferCount = 0;
  ...
  recordPoolSize(size: number): void { this.objectPoolSize = size; }
  recordTransferable(): void { this.transferableCount++; }
  recordSharedBuffer(): void { this.sharedBufferCount++; }
