...
export class OfficerGenealogyCombiner {
    private children: Map<OfficerID, ChildData> = new Map();
     ...
     */
    combineGenes(
        parent1: OfficerStats,
        parent2: OfficerStats,
        childBaseStats?: Partial<OfficerStats>,
    ): OfficerStats {
        const statsKeys: (keyof OfficerStats)[] = ['leadership', 'might', 'intelligence', 'politics', 'charisma'];
        const result: OfficerStats = { leadership: 0, might: 0, intelligence: 0, politics: 0, charisma: 0 };
