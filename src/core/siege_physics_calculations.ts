...
export interface SiegeHitResult {
    ...
    readonly terrainRangeBonus: number;   // 산악 지형 사거리 보너스
    readonly finalDamage: number;
    readonly isGate: boolean;
    readonly durabilityRemaining: number;
}

const WEAPON_STATS: Record<SiegeWeaponType, { baseDamage: number; range: number; ignoreDefense: boolean; cost: number }> = {
