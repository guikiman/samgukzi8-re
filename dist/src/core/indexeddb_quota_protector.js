...
export class IndexedDBQuotaProtector {
    constructor(dbName, storeName, maxEntries = 500) {
        this.dbName = dbName;
...
//# sourceMappingURL=indexeddb_quota_protector.js.map