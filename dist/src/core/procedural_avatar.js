...
ProceduralAvatarGenerator.FACE_COLORS = ['#f5d0a9', '#e8c39e', '#d4a574', '#c4956a', '#b8845a', '#a07050'];
ProceduralAvatarGenerator.HAT_COLORS = ['#8b0000', '#2f4f4f', '#4a3728', '#191970', '#556b2f', '#8b4513'];
ProceduralAvatarGenerator.CLOTHES_COLORS = ['#2e4057', '#6b2d5c', '#1a5b3a', '#8b4513', '#4a6741', '#5c4033', '#2c3e50'];
ProceduralAvatarGenerator.EYE_STYLES = [
...
ProceduralAvatarGenerator.MOUTH_STYLES = [
...
ProceduralAvatarGenerator.BEARD_STYLES = [
    '',
...
ProceduralAvatarGenerator.HAT_STYLES = [
    '',
    'HAT_RECT',
    'HAT_TRIANGLE',
    'HAT_SQUARE',
...
//# sourceMappingURL=procedural_avatar.js.map