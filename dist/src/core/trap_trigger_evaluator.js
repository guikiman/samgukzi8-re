...
export class TrapTriggerEvaluator {
     ...
     */
    evaluateTrigger(trapType, trapDamage, trapAuthorIntel, targetIntel) {
        ...
        // 3. 발동 성공: 상태이상 부여
        const statusEffect = trapType === 'FIRE' ? 'BURNING' : 'STOPPED';
...
//# sourceMappingURL=trap_trigger_evaluator.js.map