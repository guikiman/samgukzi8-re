export class ReputationRumorSystem {
    ...
    propagateRumor(rumorId, adjacentCityIds) {
    ...
    applyPersonalityRumorBonus(personality) {
        const multipliers = {
            AGGRESSIVE: 1.3,
            AMBITIOUS: 1.5,
            GREEDY: 1.4,
    ...
    getRumorsAbout(targetId) {
        return Array.from(this.rumors.values()).filter(r => r.targetId === targetId);
    }
}
//# sourceMappingURL=reputation_rumor_system.js.map