export class EncirclementSystem {
    evaluateEncirclement(targetFaction, worldFactions) {
        ...
        const potentialMembers = worldFactions.filter((f) => f.id !== targetFaction.id &&
    ...
    generateEncirclementEvent(targetName, memberCount, cohesion) {
        const templates = [
...
//# sourceMappingURL=encirclement_system.js.map