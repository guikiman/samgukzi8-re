...
export class FlankingZOCRestriction {
    ...
    isInZOC(tileKey, enemyPositions) {
     ...
     */
    evaluateFlanking(targetQ, targetR, allyPositions) {
    ...
    isBlockedByZOC(fromQ, fromR, toQ, toR, enemyPositions) {
...
//# sourceMappingURL=flanking_zoc_restriction.js.map