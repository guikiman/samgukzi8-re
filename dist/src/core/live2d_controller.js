...
export class Live2DEmotionController {
    constructor() {
        this.params = new Map();
        this.currentEmotion = { joy: 0, anger: 0, sadness: 0, calm: 0.5, surprise: 0 };
    ...
    computeEmotionWeights(tag, intensity) {
    ...
    setTarget(id, value) {
        ...
        if (param)
            param.targetValue = Math.max(0, Math.min(1, value));
    }
    getParam(id) { return this.params.get(id); }
    getCurrentEmotion() { return this.currentEmotion; }
}
//# sourceMappingURL=live2d_controller.js.map