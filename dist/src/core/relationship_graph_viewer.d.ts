...
export declare class RelationshipGraphViewer {
     ...
     */
    attachInteraction(canvas: HTMLCanvasElement, getGraph: () => GraphLayout | null, onNodeClick?: (nodeId: string | null) => void, onNodeDoubleClick?: (nodeId: string) => void): () => void;
