...
export class MarkovDialogueGenerator {
    constructor() {
        this.chain = new Map();
        this.contexts = ['greeting', 'farewell', 'trade', 'rumor', 'weather'];
    }
    /**
     ...
     */
    generateChain(startWord, maxWords) {
        const words = [startWord.toLowerCase()];
    ...
    getChainSize() { return this.chain.size; }
}
//# sourceMappingURL=markov_dialogue_generator.js.map