...
export class NightCombatVisionDiminisher {
    constructor() {
        this.VISION_REDUCTION = 2;
        this.AMBUSH_BONUS = 0.2;
        this.CRITICAL_BONUS = 0.15;
    }
    getNightModifiers(turn) {
