...
export class ChildRearingSystem {
     ...
     */
    simulateInheritance(parent1Stats, parent2Stats, stressLevel) {
        const stressModifier = stressLevel < 30 ? 1.0 : stressLevel < 60 ? 0.9 : 0.7;
        const inherited = {};
        const statKeys = ['leadership', 'might', 'intelligence', 'politics', 'charisma'];
     ...
     * 돌연변이 확률: 5%
     */
    simulateTraitInheritance(parentTraits, childTraits) {
        const inherited = [...childTraits];
        ...
        if (Math.random() < 0.05) {
            ...
            if (!inherited.includes(newTrait))
                inherited.push(newTrait);
        }
        return inherited;
    }
}
//# sourceMappingURL=child_rearing.js.map