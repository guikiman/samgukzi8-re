export class DebateDeckBuilder {
    static buildDeck(officerId, name, int, debateSkill) {
        const deck = [];
        // 지력/정치 기반 덱 구성
    ...
    static createCard(poolKey, dynamicValue, uniqueId) {
...
//# sourceMappingURL=debate_deck_builder.js.map