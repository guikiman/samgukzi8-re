...
export class BattleBalance {
     ...
     */
    computeChainDamage(baseDamage, chainCount, bonus = 0.15, decay = 0.12) {
        if (chainCount <= 1)
            return baseDamage;
     ...
     */
    computeMoraleDrop(distance, baseDrop = 30) {
     ...
     */
    checkLineOfSight(origin, target, heightMap) {
...
//# sourceMappingURL=battle_balance.js.map