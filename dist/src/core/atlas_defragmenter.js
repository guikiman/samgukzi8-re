...
export class AtlasDefragmenter {
     ...
     */
    free(rect) {
        const idx = this.usedRegions.findIndex((r) => r.x === rect.x && r.y === rect.y);
        if (idx >= 0) {
...
//# sourceMappingURL=atlas_defragmenter.js.map