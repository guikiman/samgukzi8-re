...
export declare class OutfitCompositor {
    private presets;
    /**
     * 복장 프리셋 등록
     */
     ...
     * 베이스 이미지에 레이어 합성
     */
    composite(baseCtx: CanvasRenderingContext2D, outfitId: string, srcCanvas: HTMLCanvasElement): void;
    /**
     * 등록된 프리셋 목록
     */
    getPresetIds(): string[];
...
//# sourceMappingURL=outfit_compositor.d.ts.map