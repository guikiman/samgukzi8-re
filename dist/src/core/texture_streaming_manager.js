...
export class TextureStreamingManager {
     ...
     */
    async transcodeBasisUniversal(buffer, targetFormat) {
     ...
     */
    uploadToGPU(gl, data, width, height) {
    ...
    getFormat() { return this.state.format; }
    dispose() {
...
//# sourceMappingURL=texture_streaming_manager.js.map