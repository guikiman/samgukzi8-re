...
export class MilitaryOfficerRecruiter {
     ...
     * 등용 확률 계산 (실행 전 예측)
     */
    predictRecruitChance(targetId, recruiterFaction) {
        const target = this.officers.get(targetId);
        if (!target || target.factionId === recruiterFaction)
            return 0;
        let chance = 50;
        if (target.factionId) {
...
//# sourceMappingURL=military_officer_recruiter.js.map