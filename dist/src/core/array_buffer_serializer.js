...
(function (FieldType) {
    FieldType[FieldType["UINT8"] = 0] = "UINT8";
    FieldType[FieldType["INT32"] = 1] = "INT32";
    FieldType[FieldType["UINT32"] = 2] = "UINT32";
    FieldType[FieldType["FLOAT32"] = 3] = "FLOAT32";
    FieldType[FieldType["STRING"] = 4] = "STRING";
    FieldType[FieldType["BOOL"] = 5] = "BOOL";
})(FieldType || (FieldType = {}));
...
export function serializeStateToBuffer(state) {
...
export function deserializeStateFromBuffer(buffer) {
    const bytes = new Uint8Array(buffer);
    const view = new DataView(buffer);
    let offset = 0;
...
export function estimateBinarySize(state) {
    const json = JSON.stringify(state);
    return HEADER_SIZE + 4 + json.length + 4;
}
const FNV_OFFSET_BASIS = 0x811C9DC5;
const FNV_PRIME = 0x01000193;
function computeBinaryChecksum(data) {
...
//# sourceMappingURL=array_buffer_serializer.js.map