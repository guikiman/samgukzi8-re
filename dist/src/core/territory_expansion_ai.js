export class TerritoryExpansionAI {
    evaluateTargets(factionPersonality, factionPower, neighbors) {
        ...
        const scored = neighbors.map((city) => {
            ...
            const total = powerRatio * weights.aggression +
    ...
    shouldDeclareWar(personality, powerRatio, targetValue, existingWars) {
...
//# sourceMappingURL=territory_expansion_ai.js.map