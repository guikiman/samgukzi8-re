...
export class SocialCeremonyManager {
    constructor() {
        this.marriages = new Set();
        this.swornBonds = new Set();
        this.participantLog = new Map();
    }
    getGift(giftId) {
    ...
    /** 선물 전달 */
    giveGift(senderId, receiverId, giftId) {
    ...
    /** 연회 개최 */
    hostBanquet(hostId, guestIds, goldSpent) {
        const results = [];
    ...
    /** 의형제 제안 */
    proposeSwornBrother(officerId1, officerId2, affection) {
    ...
    /** 결혼 제안 */
    proposeMarriage(officerId1, officerId2, affection) {
...
//# sourceMappingURL=social_ceremony_system.js.map