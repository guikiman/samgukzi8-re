...
export function relationTypeToBitmask(type) {
    return relationToBit.get(type) ?? RELATION_NONE;
}
export function bitmaskToRelationTypes(mask) {
    const result = [];
