...
function simpleLZCompress(data) {
    // 자리표시: 실제론 lz-string 또는 gzip 사용
    return btoa(encodeURIComponent(data));
}
function simpleLZDecompress(data) {
...
export class CloudSaveDeltaPacker {
    ...
    packDelta(currentState) {
        ...
        if (this.lastSnapshot) {
            // Diff 비교
            const last = JSON.parse(this.lastSnapshot);
    ...
    /** 델타 해제 */
    unpackDelta(compressed, baseState) {
        try {
...
//# sourceMappingURL=cloud_save_delta_packer.js.map