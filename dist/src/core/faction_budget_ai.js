export class FactionBudgetAI {
    allocate(totalGold, personality, atWar, stability, threatLevel) {
    ...
    getWeightProfile(personality, atWar, stability, threatLevel) {
    ...
    generateReport(allocation, factionName) {
...
//# sourceMappingURL=faction_budget_ai.js.map